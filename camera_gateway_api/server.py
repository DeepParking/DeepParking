...
def process_image(area_id, camera_id):
    print("Received process image request for area " +
          str(area_id) + " and camera " + str(camera_id))
    ...
    if data:
        area_obj = r.get("area-" + str(area_id))
        ...
        for camera in cameras:
            if camera['id'] == camera_id:
                key = "spots-" + str(area_id) + "-" + camera_id
